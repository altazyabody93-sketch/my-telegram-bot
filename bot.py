...
# ✅ Flask للتشغيل على Render + UptimeRobot
...
# ============================================================
# ✅ Flask server للتشغيل على Render + UptimeRobot
# ============================================================
app = Flask(__name__)
...
if __name__ == "__main__":
    ...
    # ✅ شغّل Flask في thread منفصل (للـ UptimeRobot + Render)
    print(f"🌐 تشغيل Flask على البورت {os.getenv('PORT', 8080)}...")
